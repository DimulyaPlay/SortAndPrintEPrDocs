...
-Изменения
1.1.2 Java от 07.10.2022

Добавлен ряд исключений в некоторые функции с выводом информационного сообщения с ошибкой
Улучшена обработка MSG файлов. Теперь скрипт не зависнет в случае плохой работы Outlookfiledrag
Штамп перенесен в правый верхний угол, добавляется после нажатия на кнопку печать на документы, которые нужно напечатать
Исправлен некорректный поворот некоторых страниц некоторых документов. Теперь вместо поворота страницы создается новая и на нее добавляется повернутая первая.



1.1.1 Java от 04.10.2022

Добавлена настройка "Добавлять штамп". Добавляет на первый лист каждого документа штамп с номером обращения и номером документа по квитанции
Исправлена несовместимость параметров Эко-режим и Сводный протокол


1.1.0 Java от 28.09.2022

Добавлена настройка "Сводный протокол". Конкатенирует все протоколы в один файл и помещает его в конец. По-умолчанию выключена.
Добавлена функция предпросмотра печати. ПКМ по кнопке печать откроет сгенерированный PDF документ со всеми заданными параметрами печати, как если бы просто нажали кнопку Печать.
Групповая печать выведена в отдельную кнопку рядом с названием вложения, функционирует точно также как и прежде. Просмотр файла снова дабл-клик.
Теперь при несоответствии файла конфигурации старый будет удален и создан новый с параметрами по-умолчанию.



1_0_8_Java от 27.09.2022 (Тестируется)

-Добавлена функция групповой печати(только для .MSG).
До 9 групп. ЛКМ/ПКМ по названию изменяет группу вперед-назад(меняется цвет названия)
Теперь файл можно открыть по нажатию СКМ (Tkinter не разеляет двойной клик от одинарного: при двойном клике также срабатывает и одинарный, цифра+ЛКМ также не поддерживается...)
Параметры также, как и раньше, для всей группы берутся от самого нижнего члена группы.
Очередность добавления также вляет на порядок печати
-Добавлены несколько общих исключений.
