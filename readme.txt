...
-Изменения 
1_0_6_Java от 16.09.2022

Добавлена проверка соответствия номера квитанции(встретились в архиве две квитанции одновременно)
Добавлены плейсхолдеры для печати нескольких копий
